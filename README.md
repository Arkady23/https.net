...
Сервер https.net предусматривает скорастной метод вставки содержимого локального файла в исходящий поток. Файл вставляется минуя буферы памяти непосредственно в трафик ответа. Для этого в строке возврата статуса нужно указать параметр filename, например:
```
...
2.2.1 July 2026. Добавлена возможность использовать строку со статусом возврата во всех случаях независимо от наличия расширения или его отсутствия.  
