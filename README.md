...
2.3.1 August 2026. Добавлена возможность задавать пароль сертификату, использовать обновление записей AAAA на сервисе Cloudflare в части динамического адреса IPv6, который берется из свойств сети где работает https.net. Также реализовано слежение за изменением сертификата. Если сертификат изменился, то сервер автоматически обновит его не прерывая работу.  
